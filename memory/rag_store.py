...
class RAGStore:
    ...
    def search(self, query_embedding: np.ndarray, top_k: int = 3) -> List[Tuple[Dict[str, str], float]]:
        """
    ...
    def save(self):
        ...
        if self.index.ntotal > 0:
            ...
            print(f"Saved FAISS index with {self.index.ntotal} vectors to {self.index_file}")
